...
static const GtkActionEntry pluma_menu_entries[] =
{
	...
	{ "FileCloseTabsRight", NULL, N_("Close Tabs to the _Right"), NULL,
	  N_("Close all tabs to the right of the current tab"), G_CALLBACK (_pluma_cmd_file_close_tabs_right) },
	{ "FileCloseOtherTabs", NULL, N_("Close _Other Tabs"), NULL,
	  N_("Close all tabs except the current tab"), G_CALLBACK (_pluma_cmd_file_close_other_tabs) },
