...
/* GMenu API used by bundled and third-party plugins to add menu items.
 * The section id must name a mutable section in pluma-menus.ui (e.g.
 * "plugin-tools-section", "plugin-edit-section", "plugin-search-section"). */
